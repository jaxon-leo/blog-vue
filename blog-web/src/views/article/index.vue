...
export default {
  ...
  methods: {
     ...
     */
    getLoadingImage() {
      return 'https://minio.dejavu.zone/dejavu-blog/common/lazy.gif'
    },
    /**
     * 生成目录
     */
    ...
    shareToWeibo() {
      const url = encodeURIComponent(this.currentUrl)
      const title = encodeURIComponent(`${this.article.title} - dejavu博客`)
      window.open(
        ...
        entries.forEach(entry => {
          if (entry.isIntersecting) {
            ...
            if (actualSrc) {
              ...
              tempImg.onerror = () => {
                img.src = 'https://minio.dejavu.zone/dejavu-blog/common/img-error.jpg'
