  ...
  <div>
    ...
    <div class="message-banner" :style="cover">
      ...
      <div class="barrage-container">
        <vue-danmaku class="danmaku" :danmus="barrageList" style="height: 100%; width: 100%" useSlot :speeds="150"
          :channels="15">
...
export default {
  ...
  computed: {
    cover() {
      var cover = "https://minio.dejavu.zone/dejavu-blog/common/memo-background.png";
