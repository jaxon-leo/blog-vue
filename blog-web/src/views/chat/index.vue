    ...
    <div class="chat-list-container" :class="{ 'mobile-hidden': isMobile && isListHidden }">
      ...
      <div class="chat-list">
        ...
        <template v-else-if="currentNav === 'friends'">
          <div v-for="friend in friendsList" :key="friend.id" class="friend-item" :class="{
        ...
        <div v-for="(msg, index) in currentChat.messages" :key="generateUniqueKey(msg, index)" :class="[
          ...
          <div class="message-content">
            <div class="message-header">
              ...
              " class="sender-name">
                <span :class="msg.userId === 1 ? 'author-name' : msg.userId ? 'user-name' : 'assistant-name'">{{
                  msg.name
                }}</span>
                <span v-if="msg.userId === 1" class="author-tag">作者</span>
                <span v-if="!msg.userId" class="assistant-tag">A I</span>
                <span v-if="msg.userId && msg.userId != 1" class="user-tag">用户</span>
      ...
      chatList: [
        {
          id: 1,
          name: "博客交流群",
          avatar: this.$store.state.webSiteInfo.logo ? this.$store.state.webSiteInfo.logo : 'https://minio.dejavu.zone/dejavu-blog/common/captcha_backgroup.jpg',
          lastMessage: "",
          lastTime: "",
        },
      ],
