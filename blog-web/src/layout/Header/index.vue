        ...
        <div class="user-info">
          <div v-if="$store.state.userInfo" class="user-section" @mouseleave="showDropdown = false">
            ...
            <div class="user-dropdown" v-show="showDropdown">
              ...
              <router-link to="/user/profile/index" class="dropdown-item">
...
export default {
      ...
      menuItems: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              name: '网盘系统',
              path: 'https://pan.dejavu.zone',
              icon: 'fas fa-cloud',
              colorClass: 'cloud-link',
              external: true
            },
            {
              name: '后台管理',
              path: import.meta.env.VITE_APP_ADMIN_URL || 'https://admin.dejavu.zone',
              icon: 'fas fa-tv',
  ...
  methods: {
    ...
    showBage() {
      // console.log('是否有未读消息：' + this.$store.state.isUnread)
