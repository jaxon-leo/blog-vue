    ...
    <div class="app-container">
        ...
        <el-card class="box-card">
            ...
            <el-table v-loading="loading" :data="fileList" style="width: 100%">
                ...
                <el-table-column label="存储平台" align="center" width="100" prop="platform">
                    <template #default="scope">
                        <span v-for="item in ossOptions">
                            <!-- v-if 和 v-for 会在同一个元素上操作，导致 Vue 的渲染不稳定 -->
                            <!-- <div/>本身不会产生任何可视化效果,但Vue 会把它当作一个新的 DOM 元素来渲染，强制创建一个新的作用域，
                             这样 Vue 就能够确保在循环和条件判断过程中能够正确渲染每个 el-tag，避免了 Vue 内部的渲染冲突-->
                            <div />
